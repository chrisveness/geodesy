/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
/*  Geodesy Test Harness - latlon-vincenty                            (c) Chris Veness 2014-2015  */
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
...
describe('latlon-vincenty', function() {
    ...
    test('vincenty antipodal distance',            function() { LatLon(0, 0).distanceTo(LatLon(0.5, 179.5)).should.equal(19936288.579); });

    test('vincenty antipodal convergence failure', function() { LatLon(0, 0).distanceTo(LatLon(0.5, 179.7)).should.be.NaN; });
});
